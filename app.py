...
def get_user_odd_even():
    while True:
        choice = request.form.get("odd_even").strip().lower()
...
def play_innings(batsman_name, bowler_name, target=None):
    ...
    while True:
        if batsman_name == "You":
            ...
            batsman = int(request.form.get('user_input'))
...
def toss():
    ...
    user_num = int(request.form.get('user_num'))
    ...
    if user_choice == result:
        ...
        while True:
            bat_or_bowl = request.form.get('choice')
